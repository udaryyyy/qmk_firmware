...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE_JP] = LAYOUT( \
    KC_ESC,   KC_Q,          KC_W,        KC_E,    KC_R,    KC_T,     XXXXXXX,      /*|*/ TO(NUMERIC),  KC_Y,     KC_U,     KC_I,   KC_O,        KC_P,         KC_MINS, \
    ...
    KC_LCTL,  MO(WITH_FUNC), MO(NUMERIC), KC_LALT, KC_DEL,  KC_SPACE, KC_BSPC,      /*|*/ KC_BSPC,      KC_SPACE, KC_SPACE, KC_ENT, TG(BASE_EN), MO(SHIFT_NUM),KC_RGUI \
  ),

  [BASE_EN] = LAYOUT( \
    KC_ESC,   KC_Q,          KC_W,        KC_E,    KC_R,    KC_T,     XXXXXXX,      /*|*/ _______,      KC_Y,    KC_U,   KC_I,        KC_O,          KC_P,    KC_MINS, \
  ...
  [NUMERIC] = LAYOUT( \
    KC_ESC,   XXXXXXX,       XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX,  KC_PSCR,      /*|*/ TO(BASE_EN),  KC_7,    KC_8,    KC_9,       XXXXXXX,       KC_PMNS, KC_PPLS, \
