...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, XXXXXXX,KC_UP, TG(NUMERIC),   \
    KC_LCTL,   KC_LALT,    KC_LGUI, MO(WITH_FN_KEY),  KC_SPC,     KC_BSPC,  KC_ENT, LALT(KC_GRV),               KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [WITH_FN_KEY] = LAYOUT( \
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,    KC_F6,     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, LALT(KC_GRV), KC_DEL, \
    RGB_TOG,   RGBRST,  RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_UP, XXXXXXX, XXXXXXX, \
    KC_PSCR,     RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_RGHT,        _______, \
  ...
  [NUMERIC] = LAYOUT( \
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,   XXXXXXX,   KC_PDOT, KC_1,    KC_2,    KC_3,    XXXXXXX,  _______, KC_UP,  _______, \
